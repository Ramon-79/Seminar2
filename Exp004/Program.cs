...
// тут сделаю еще интереснее, я зациклю программу, что б мы могли писать вичла и получать результаты, пока не напишем ключ-фразу
...
while( input?.ToLower() != end)
{
    ...
    // Вот этот кусоче отвечает за самый верхний цикл. Аосле отработки всех логик и методов, мы можем перестать вводить что-то
    // И написать слово "конец" (в разном регистре), а можем нажать Enter и будеть писать числа дальше.
